...
(
  ...
  constraint lfda FOREIGN KEY(productLine) REFERENCES productlines(productLine)
);
CREATE TABLE employees (
  ...
  constraint lfda1 FOREIGN KEY(officeCode) REFERENCES offices(officeCode),
  constraint lfda2 FOREIGN KEY(reportsTo)  REFERENCES employees(employeeNumber)
);
...
CREATE TABLE customers (
  ...
  constraint lfda3 FOREIGN KEY (salesRepEmployeeNumber) REFERENCES employees(employeeNumber)
);
CREATE TABLE orders (
